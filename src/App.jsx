...
const lowerFeatures = [
  ['gear', 'Engineering Excellence', 'Advanced design and engineering expertise.'],
  ['robot', 'Custom Integration', 'Seamless integration with your existing systems.'],
  ['check', 'Proven Results', 'Delivering measurable ROI and operational improvement.'],
  ['users', 'Client Focused', 'We are committed to your long-term success.'],
];
    ...
    <div style={{ minHeight: '100vh', background: COLORS.page, color: COLORS.text, fontFamily: 'Arial, Helvetica, sans-serif' }}>
      ...
      <header className="header">
        ...
        <div className="headerActions">
          <button className="yellowBtn headerContact" onClick={() => navTo('contact')}>Contact Us</button>
...
.hamburger { display: none; background: rgba(255,255,255,.06); color: #fff; border: 1px solid rgba(255,255,255,.12); min-width: 92px; height: 48px; border-radius: 14px; align-items: center; justify-content: center; gap: 8px; font-weight: 900; text-transform: uppercase; letter-spacing: .04em; }
.mobileNav { display: none; background: ${COLORS.navy}; padding: 14px 24px 24px; gap: 10px; border-top: 1px solid rgba(255,255,255,.1); box-shadow: 0 18px 40px rgba(0,0,0,.28); }
.mobileNav button { display: block; width: 100%; text-align: left; background: transparent; border: 1px solid rgba(255,255,255,.12); color: #fff; border-radius: 14px; padding: 14px 16px; font-weight: 800; text-transform: uppercase; letter-spacing: .04em; }
